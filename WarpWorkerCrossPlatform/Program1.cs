...
namespace WarpWorker
{
    ...
    class Program1
    {
        ...
        static string PipeName = "manual input";
        ...
        static void Main(string[] args)
        {
            ...
            DeviceID = 0; /*int.Parse(args[0]) % GPU.GetDeviceCount();*/

            var Command = new NamedSerializableObject(args[0]);
            ...
            while (true)
            {
                ...
                //Command = (NamedSerializableObject)Formatter.Deserialize(PipeReceive);
